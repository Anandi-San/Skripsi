...
<div class="flex flex-col items-center justify-center my-8 ml-4 md:ml-16 lg:ml-36 mr-4">
    ...
    <div class="bg-customWhite w-full shadow-md mt-2 border border-gray-500 overflow-x-auto">
        <div class="flex flex-row justify-between p-2 md:p-4">
            ...
            <p class="text-center w-1/8 text-xs md:text-sm">Nama Ormawa</p>
            <p class="text-center w-1/8 text-xs md:text-sm">Proposal Legalitas</p>
            <p class="text-center w-1/8 text-xs md:text-sm">AD/ART</p>
            <p class="text-center w-1/8 text-xs md:text-sm">Surat Permohonan</p>
            <p class="text-center w-1/8 text-xs md:text-sm whitespace-normal">Daftar Nama<br>Kepengurusan</p>
            <p class="text-center w-1/8 text-xs md:text-sm whitespace-normal">Daftar Sarana<br>Prasarana</p>
            <p class="text-center w-1/8 text-xs md:text-sm">GBHK</p>
            <p class="text-center w-1/8 text-xs md:text-sm">LPJ Kepengurusan</p>
            <p class="text-center w-1/12 text-xs md:text-sm">Status</p>
            <p class="text-center w-1/12 text-xs md:text-sm">Operasi</p>
        </div>
    </div>
    <!-- Isi tabel -->
    <div class="container bg-customWhite w-full md:w-full mt-2 shadow-md border border-gray-500 overflow-x-auto">
        ...
        <div class="flex flex-row justify-between p-2 md:p-4 border-b border-gray-300">
            ...
            <p class="text-center w-1/8 text-xs md:text-sm">
            ...
            <p class="w-1/12 text-xs md:text-sm bg-customBlack p-2 rounded-lg  text-customWhite">
                {{ $item->status ?? 'Pending' }}
            </p>
